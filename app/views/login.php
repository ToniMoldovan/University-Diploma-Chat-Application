            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/login-user" method="POST">
                        <div class="input-group form-group">
                            ...
                            <input type="text" name="username-login" id="username-login" required class="form-control" placeholder="username">
                        ...
                        <div class="input-group form-group">
                            ...
                            <input type="password" name="password-login" id="password-login" required class="form-control" placeholder="password">
                        </div>
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-center links">
                        Don't have an account?<a id="sign-up-btn" class="add-btn-like-properties">Sign Up</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <form action="/register-user" method="POST">
                        ...
                        <div class="input-group form-group">
                            ...
                            <input type="text" class="form-control" name="profile-picture-link" placeholder="Profile picture link (optional)">
                        </div>

                        <div class="form-group">
                            <input id="submit-register-btn" type="submit" name="submitRegister" value="Register" class="btn float-right login_btn">
                        </div>
                    </form>
                </div>
                <div class="card-footer">
                    <div class="d-flex justify-content-center links">
                        Already have an account?<a id="login-btn" class="add-btn-like-properties">Login here</a>
                    </div>
                </div>
            </div>
        </div>
